...
RS2V Custom Server is a clean-room, modular, extensible dedicated-server **emulator** for Rising Storm 2: Vietnam (an Unreal Engine 3 game, `EngineVersion 7258`), built in C++23. It is organized around a production-style architecture with telemetry, security, and networking subsystems.
